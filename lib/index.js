  ...
  _createClass(Service, [{
    ...
    value: function patch(id, data, params) {
      ...
      return this.model.findById(id).then(function (result) {
        ...
        var patchData = Object.assign({}, JSON.parse(JSON.stringify(result)), JSON.parse(JSON.stringify(data)));
        delete patchData.id;
        return _this4.model.replaceById(id, patchData).then(function (result1) {
